 ...
 */
public class addTheLoai extends javax.swing.JDialog {

    /**
     * Creates new form addTheLoai
     */
    private TheloaiService theloaiService = new TheLoaiServiceImpl();
    public addTheLoai(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
       ...
       public void clearForm(){
        ...
        public String genMaTheLoai() {
        for (int i = 0; i < theloaiService.getAll().size() + 1; i++) {
            String ma = "VC" + i;
            if (theloaiService.getOne(ma) == null) {
                return ma;
            }
        }
        return null;
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        s.setMa(genMaTheLoai());
        s.setTenTL(txtTen.getText());
        theloaiService.add(s);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addTheLoai.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
